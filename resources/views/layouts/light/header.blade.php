    ...
    <div class="nav-right col-8 pull-right right-header p-0">
      <ul class="nav-menus">
        ...
        <li class="onhover-dropdown">
          <div class="notification-box"><i data-feather="bell"> </i><span class="badge badge-pill badge-secondary">{{count($notifications)}}</span></div>
          <ul class="notification-dropdown onhover-show-div">
            ...
            <li>
              <div class="media">
                <p><i class="fa fa-circle-o mr-3 font-danger"></i>{{$notification->description}}<span class="pull-right">{{date('h:i:s', strtotime($notification->created_at))}}</span></p>
                <div class="close-circle">
                  <form action="/notification/{{$notification->id}}" method="POST">
                    @csrf
                    <a href="#" onclick="this.parentNode.submit()"><i data-feather="x"></i></a>
                  </form>
                </div>
              </div>
            </li>
          ...
          <ul class="profile-dropdown onhover-show-div">
            ...
            <li>
              <form id="logout" action="/logout" method="post">
                @csrf
                <a onclick="document.getElementById('logout').submit()" href="#" type="submit"><i data-feather="log-in"> </i><span>Cerrar Sesión</span></a>
              </form>
            </li>
          </ul>
        </li>
